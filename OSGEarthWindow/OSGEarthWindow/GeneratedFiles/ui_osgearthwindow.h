...
public:
    ...
    void setupUi(QMainWindow *OSGEarthWindowClass)
    {
        ...
        dockWidget->setMinimumSize(QSize(128, 393));
        ...
        treeView->header()->setDefaultSectionSize(50);
        treeView->header()->setMinimumSectionSize(20);

        gridLayout_2->addWidget(treeView, 3, 1, 1, 1);
        ...
        gridLayout_2->addWidget(pushButtonClose, 6, 1, 1, 1);
